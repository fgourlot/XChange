...
public class BittrexOrderDelta {
    ...
    public BittrexOrderDelta(String id, String marketSymbol, String direction, String type, BigDecimal quantity, BigDecimal limit, BigDecimal ceiling, String timeInForce, String clientOrderId, BigDecimal fillQuantity, BigDecimal commission, BigDecimal proceeds, String status, Date createdAt, Date updatedAt, Date closedAt, BittrexOrderToCancel orderToCancel) {
        this.id = id;
